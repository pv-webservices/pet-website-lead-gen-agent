...
// 10 keyword variants maximise unique place_id coverage for the 30-lead target.
// insertOrIgnoreLead deduplicates by place_id, so overlapping results are harmless.
const SCRAPE_JOBS: ScrapeJob[] = [
  { query: 'veterinary clinic',   location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'vet clinic',          location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'animal hospital',     location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'pet clinic',          location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'veterinary doctor',   location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'dog clinic',          location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'veterinary hospital', location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'pet hospital',        location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'cat clinic',          location: 'Mumbai, Maharashtra, India', niche: 'vet' },
  { query: 'small animal clinic', location: 'Mumbai, Maharashtra, India', niche: 'vet' },
];
...
async function main(): Promise<void> {
  console.log('=== Mumbai Vet Lead Scraper (target: 30 leads) ===');
