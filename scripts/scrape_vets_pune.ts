...
// 10 keyword variants to maximise unique place_id coverage for the 30-lead target.
// insertOrIgnoreLead deduplicates by place_id, so overlapping results are harmless.
const SCRAPE_JOBS: ScrapeJob[] = [
  { query: 'veterinary clinic',   location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'vet clinic',          location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'animal hospital',     location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'pet clinic',          location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'veterinary doctor',   location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'dog clinic',          location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'veterinary hospital', location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'pet hospital',        location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'cat clinic',          location: 'Pune, Maharashtra, India', niche: 'vet' },
  { query: 'small animal clinic', location: 'Pune, Maharashtra, India', niche: 'vet' },
];
...
function inferCity(place: ApifyPlaceResult, fallbackLocation: string): string | null {
  ...
  if (address.includes('pimpri') || address.includes('chinchwad')) return 'Pimpri-Chinchwad';
  if (address.includes('pimpri-chinchwad'))                       return 'Pimpri-Chinchwad';
...
async function main(): Promise<void> {
  console.log('=== Pune Vet Lead Scraper (target: 30 leads) ===');
