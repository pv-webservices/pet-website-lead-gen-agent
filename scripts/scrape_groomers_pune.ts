...
const SCRAPE_JOBS: ScrapeJob[] = [
  { query: 'pet groomer',        location: 'Pune, Maharashtra, India', niche: 'groomer' },
  { query: 'dog groomer',        location: 'Pune, Maharashtra, India', niche: 'groomer' },
  { query: 'pet salon',          location: 'Pune, Maharashtra, India', niche: 'groomer' },
  { query: 'dog grooming salon', location: 'Pune, Maharashtra, India', niche: 'groomer' },
  { query: 'pet grooming',       location: 'Pune, Maharashtra, India', niche: 'groomer' },
  { query: 'dog salon',          location: 'Pune, Maharashtra, India', niche: 'groomer' },
  { query: 'cat groomer',        location: 'Pune, Maharashtra, India', niche: 'groomer' },
  { query: 'mobile pet groomer', location: 'Pune, Maharashtra, India', niche: 'groomer' },
];
...
async function main(): Promise<void> {
  console.log('=== Pune Groomer Lead Scraper (target: 20 leads) ===');
